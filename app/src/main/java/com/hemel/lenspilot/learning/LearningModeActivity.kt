        ...
        when (type) {
            ...
            "image" -> {
                ...
                if (imgB64 != null) {
                    ...
                    // Image fetch failed server-side — still give the
                    // narration rather than stalling the lesson.
                    diagramImage.visibility = View.GONE
            ...
            "highlight" -> {
                // Re-highlights an earlier diagram/image (by target_id) in
                // sync with new narration — applied to whatever is
                // currently on screen, since this build doesn't yet keep a
                // scrollable history of every past board segment.
                captionCard.visibility = View.GONE
                speakingIndicator.visibility = View.GONE
