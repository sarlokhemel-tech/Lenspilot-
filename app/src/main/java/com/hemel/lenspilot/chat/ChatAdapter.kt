...
class ChatAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            ...
            is AiVH -> {
                holder.text.text = m.text
                // No point offering to report an empty/still-streaming bubble.
                val reportable = m.text.isNotBlank() && m.text != "…"
                holder.report.visibility = if (reportable) View.VISIBLE else View.GONE
